...
# armyDict = {'sumInH': 5, 'moloch': {16: [[[-0.8689655172413793, -0.4827586206896552], 0, 1, 240, True, 2]], 21: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 19], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 29]], 22: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 8], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 10], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 15], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 17]], 23: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 7], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 9], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 23], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 30], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 34]], 1: [[[0.0, 0.013793103448275862], 0, 20, 0, True, 0]], 13: [[[-0.8689655172413793, 0.5172413793103449], 0, 1, 0, True, 1]], 3: [[[0.0, -0.9862068965517241], 0, 1, 240, True, 3]], 18: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 4], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 16]], 6: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 5]], 7: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 6]], 9: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 11]], 19: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 12], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 31]], 8: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 13]], 17: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 14], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 18]], 4: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 20]], 20: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 21], [[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 26]], 2: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 22]], 5: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 24]], 12: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 25]], 15: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 27]], 10: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 28]], 11: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 32]], 14: [[[-4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 33]]}, 'mississippi': {8: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 33]], 13: [[[1.7310344827586206, 0.013793103448275862], 0, 1, 60, True, 6], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 28]], 16: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 12], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 23], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 24]], 18: [[[2.6, -0.4827586206896552], 0, 1, 0, True, 2], [[2.6, 0.5172413793103449], 0, 1, 0, True, 3], [[3.4689655172413794, 0.013793103448275862], 0, 1, 0, True, 7], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 22]], 1: [[[0.0, 1.013793103448276], 0, 20, 0, True, 0]], 14: [[[0.8620689655172413, 0.5172413793103449], 0, 1, 0, True, 1], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 9], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 16]], 17: [[[0.8620689655172413, -0.4827586206896552], 0, 1, 60, True, 4], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 26], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 27], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 29]], 4: [[[1.7310344827586206, 0.013793103448275862], 0, 1, 0, True, 5]], 15: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 8], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 10], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 30]], 7: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 11]], 11: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 13], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 21]], 10: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 14], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 20]], 9: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 15], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 17]], 5: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 18]], 3: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 19]], 12: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 25], [[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 34]], 6: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 31]], 2: [[[4.0344827586206895, -1.986206896551724], 1, 1, 0, 0, 32]]}}
...
def choiceArmy(t, columns = 1):
	lenArmyD = len(t)#количество вариантов
	...
	while 1:
		...
		for i in range(lenArmyD): 
			...
			clrarmy = colorArmy[t[i]] if t[i] in colorArmy else (255, 255, 255)
			draw_text(Screen, t[i], x, y, szt, 0, clrarmy)
			
			if not i%2 or not columns:#разделительные линии
				draw_text(Screen, '_'*25+('|'*columns)+'_'*25, center[0], i*szChArmy/2, szChArmy, 0)
...
if lenArmyDict == len(armyDict):
	...
	while running:
		...
		t = ['загрузить','добавить наёмников','разрешение экрана: '+str(size), 'поле '+map27+'на 27 ячеек', \
		...
		# pg.display.update()
		# MyClock.tick(60)
		print(choiceArmy(armyDictList, 1))
		for event in pg.event.get():
